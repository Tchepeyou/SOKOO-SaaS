  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20bd5a] hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/30 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#25D366]/50"
